...
idleoffsets = {'1', '-3'} -- I recommend you have your idle offset at 0
leftoffsets = {'-4', '0'}
downoffsets = {'6','1'}
upoffsets = {'1', '-3'}
rightoffsets = {'24', '-2'}
...
idle_xml_name = 'WH_Intro'
left_xml_name = 'BA_Missingno_Left'
down_xml_name = 'BA_Missingno_Down'
up_xml_name = 'BA_Missingno_Up'
right_xml_name = 'BA_Missingno_Right'
...
name_of_character_xml = 'WA_assets'
name_of_character = 'WHIntro'
