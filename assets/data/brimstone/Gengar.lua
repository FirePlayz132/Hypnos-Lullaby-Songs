...
idleoffsets = {'21', '-12'} -- I recommend you have your idle offset at 0
leftoffsets = {'15', '-11'}
downoffsets = {'18','-11'}
upoffsets = {'21', '-12'}
rightoffsets = {'22', '-12'}

leftMissoffsets = {'0', '1'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'15', '1'}  --
upMissoffsets = {'0', '0'}    --
rightMissoffsets = {'30', '-6'} --
...
idle_xml_name = 'gengar idle'
left_xml_name = 'gengar left'
down_xml_name = 'gengar down'
up_xml_name = 'gengar up'
right_xml_name = 'gengar right'

left_miss_xml_name = 'BA_Missingno_Miss Left'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'BA_Missingno_Miss Down'   --
up_miss_xml_name = 'BA_Missingno_Miss Up'       --
right_miss_xml_name = 'BA_Missingno_Miss Right' --
...
name_of_notetype = 'Gengar'
name_of_notetype2 = 'GF Sing' -- for multiple characters singing at the same time
